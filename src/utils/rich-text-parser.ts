// // Based on https://raw.githubidentitycontent.com/brussell98/discord-markdown/master/index.js
...
// 		},
// 		html: function(node, output, state) {
// 			return htmlTag('span', discordCallback.identity(node), { class: 'd-mention d-identity' }, state);
// 		}
// 	},
// 	discordChannel: {
// 		order: markdown.defaultRules.strong.order,
...
// 		},
// 		html: function(node, output, state) {
// 			return htmlTag('span', discordCallback.everyone(node), { class: 'd-mention d-identity' }, state);
// 		}
// 	},
// 	discordHere: {
// 		order: markdown.defaultRules.strong.order,
...
// 		},
// 		html: function(node, output, state) {
// 			return htmlTag('span', discordCallback.here(node), { class: 'd-mention d-identity' }, state);
// 		}
// 	}
// };
