				...
				${choose(
					...
					[Rivet.cloud.BootstrapCluster.Oss, () =>
						html`<h1 class="text-5xl mt-3.5 mb-8">Welcome to Rivet OSS!</h1>
							...
							>
							<p class="text-lg">
								If you have email sending configured on your backend, use the login
								below.
							</p>`],
					...
					() => html`
						...
						>
							...
							<stylized-button .trigger="${this.dispatchLogin.bind(this)}"
								>${when(
									![GlobalStatus.Consenting, GlobalStatus.Unregistered, GlobalStatus.Connected].includes(this.status),
