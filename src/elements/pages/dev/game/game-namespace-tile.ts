...
export default class GameNamespaceTile extends LitElement {
	...
	render() {
		return html`
			<a
				class="m-auto h-full p-2 px-5 bg-raised-bg rounded-lg border-white/10 border flex flex-row place-content-between hover:bg-raised-hover hover:-translate-y-px transition"
