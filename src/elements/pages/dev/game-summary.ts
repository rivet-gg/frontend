				...
				<div class="flex flex-col px-16 pt-6 text-slate-300">
					<div class="flex flex-row place-content-end">
						<div>
							...
							<div class="flex flex-col text-lg">
								<h4 class="font-light italic text-white/40">v${this.getNamespaceVersion(this.namespace).displayName}</h4>
								<h4 class="font-light italic text-white/40">${utils.formatDateLong(this.getNamespaceVersion(this.namespace).createTs)}</h4>
					...
					<div class="pt-6 space-y-2">
						...
						<div class="flex flex-row space-x-6 pb-2 text-purple-400 font-semibold">
							...
							<a class="border-transparent text-zinc-600 hover:border-zinc-900 dark:text-white dark:hover:border-white dark:hover:opacity-100 lh-full flex h-full shrink-0 items-center gap-1 whitespace-nowrap border-b-2 pt-1 text-md font-medium opacity-90" href="https://rivet.gg/learn/unity"><span class="bg-clip-text bg-gradient-to-r text-transparent font-semibold from-cyan-300 to-cyan-500">Unity</span></a>
							<a class="border-transparent text-zinc-600 hover:border-zinc-900 dark:text-white dark:hover:border-white dark:hover:opacity-100 lh-full flex h-full shrink-0 items-center gap-1 whitespace-nowrap border-b-2 pt-1 text-md font-medium opacity-90" href="https://rivet.gg/learn/unreal"><span class="bg-clip-text bg-gradient-to-r text-transparent font-semibold from-rose-400 to-rose-600">Unreal</span></a>
							<a class="border-transparent text-zinc-900 hover:border-zinc-900 dark:text-white dark:hover:border-white dark:hover:opacity-100 lh-full flex h-full shrink-0 items-center gap-1 whitespace-nowrap border-b-2 pt-1 text-md font-medium opacity-90" href="https://rivet.gg/learn/html5" aria-current="page"><span class="bg-clip-text bg-gradient-to-r text-transparent font-semibold from-orange-400 to-orange-600">HTML5</span></a>
						</div>
						<code class="text-md text-slate-300 italic">rivet deploy -n prod</code>
					</div>

					<div class="pt-6">
						<stylized-button class="mt-auto">Manage Version</stylized-button>
					</div>
