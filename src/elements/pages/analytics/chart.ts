...
// 	@property({ type: Object })
// 	dataSet: Rivet.cloud.NamespaceAnalyticsDataSet = null;
...
// 			else if (this.dataSet.identityAccounts) this.identityAccountsChart(this.dataSet.identityAccounts);
// 		}
// 	}
...
// 	playerCountChart(data: Rivet.cloud.PlayerCountDataSet) {
...
// 	playerCountByRegionChart(data: Rivet.cloud.PlayerCountByRegionDataSet) {
...
// 	playerCountByGameModeChart(data: Rivet.cloud.PlayerCountByGameModeDataSet) {
// 		let playerCounts = data.playerCount.map((y, i) => ({ x: data.ts[i], y }));
...
// 	lobbyCountChart(data: Rivet.cloud.LobbyCountDataSet) {
// 		this.structuredDataSets = [
// 			{
// 				label: 'Total Lobbies',
...
// 	lobbyCountByRegionChart(data: Rivet.cloud.LobbyCountByRegionDataSet) {
...
// 	lobbyCountByGameModeChart(data: Rivet.cloud.LobbyCountByGameModeDataSet) {
// 		let lobbyCounts = data.lobbyCount.map((y, i) => ({ x: data.ts[i], y }));
// 		let uniqueGameModes = Array.from(new Set(data.gameModeNameId));
// 		this.structuredDataSets = uniqueGameModes.map(nameId => ({
// 			label: nameId,
...
// 	avgPlayDurationChart(data: Rivet.cloud.AvgPlayDurationDataSet) {
// 		this.structuredDataSets = [
// 			{
// 				label: 'Duration',
...
// 	newPlayersPerSecondChart(data: Rivet.cloud.NewPlayersPerSecondDataSet) {
// 		this.structuredDataSets = [
// 			{
// 				label: 'New Players',
...
// 	newLobbiesPerSecondChart(data: Rivet.cloud.NewLobbiesPerSecondDataSet) {
// 		this.structuredDataSets = [
// 			{
// 				label: 'New Lobbies',
...
// 	destroyedLobbiesByFailureChart(data: Rivet.cloud.DestroyedLobbiesByFailureDataSet) {
...
// 	destroyedLobbiesByExitCodeChart(data: Rivet.cloud.DestroyedLobbiesByExitCodeDataSet) {
// 		let lobbyCounts = data.destroyedLobbyCount.map((y, i) => ({ x: data.ts[i], y }));
...
// 	failedLobbiesChart(data: Rivet.cloud.FailedLobbiesDataSet) {
// 		this.structuredDataSets = [
// 			{
// 				label: 'Lobby Count',
...
// 	lobbyReadyTimeChart(data: Rivet.cloud.LobbyReadyTimeDataSet) {
// 		this.structuredDataSets = [
// 			{
...
// 	identityAccountsChart(data: Rivet.cloud.IdentityAccountsDataSet) {
// 		this.structuredDataSets = [
// 			{
// 				label: 'Total Accounts',
// 				data: data.totalAccountCount.map((y, i) => ({ x: data.ts[i], y }))
// 			},
// 			{
// 				label: 'Registered Accounts',
// 				data: data.registeredAccountCount.map((y, i) => ({ x: data.ts[i], y }))
// 			}
// 		];

// 		this.displayTitle = 'Accounts';
// 		this.createOrUpdateChart(createLineChart);
// 	}
