...
type GameBillingUsageProgressProps = CommonUsageProgressProps &
  (FreeUsageProgressProps | PaidUsageProgressProps);

export function GameBillingUsageProgress(props: GameBillingUsageProgressProps) {
  if (props.isFree) {
    return (
    ...
    <>
      ...
      >
        ...
        <div className="flex-shrink-0 text-center">
          ...
          <p className="text-4xl font-bold">{formatCurrency(overage)}</p>
        </div>
      </Flex>
    </>
  );
