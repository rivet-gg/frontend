...
var CloudServiceClient = (function (_super) {
    __extends(CloudServiceClient, _super);
    function CloudServiceClient(configuration) {
        var _this = this;
        function rivetConfig(input) {
            ...
            if (endpoint === null) {
                try {
                    endpoint = (_b = process.env.RIVET_CLOUD_API_URL) !== null && _b !== void 0 ? _b : null;
                }
                catch (_f) {
                }
                if (endpoint === null) {
                    endpoint = "https://cloud.api.rivet.gg/v1";
                }
            }
            var token = (_c = input.token) !== null && _c !== void 0 ? _c : null;
            if (token === null) {
                try {
                    token = (_e = (_d = process.env.RIVET_CLOUD_TOKEN) !== null && _d !== void 0 ? _d : process.env.RIVET_TOKEN) !== null && _e !== void 0 ? _e : null;
                }
                catch (_g) {
                }
            }
    ...
    CloudServiceClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return CloudServiceClient;
}(__Client));
export { CloudServiceClient };
