...
export declare type ServiceInputTypes = AddNamespaceDomainCommandInput | CompleteCustomAvatarUploadCommandInput | CompleteUploadCommandInput | ConvertGroupCommandInput | CreateCloudTokenCommandInput | CreateGameBuildCommandInput | CreateGameCdnSiteCommandInput | CreateGameCommandInput | CreateGameNamespaceCommandInput | CreateGameNamespaceTokenDevelopmentCommandInput | CreateGameNamespaceTokenPublicCommandInput | CreateGameVersionCommandInput | DeleteMatchmakerLobbyCommandInput | ExportLobbyLogsCommandInput | ExportMatchmakerLobbyHistoryCommandInput | GameBannerUploadCompleteCommandInput | GameBannerUploadPrepareCommandInput | GameLogoUploadCompleteCommandInput | GameLogoUploadPrepareCommandInput | GetGameBillingCommandInput | GetGameBillingPlansCommandInput | GetGameByIdCommandInput | GetGameNamespaceByIdCommandInput | GetGameVersionByIdCommandInput | GetGamesCommandInput | GetGroupBillingCommandInput | GetGroupInvoicesListCommandInput | GetLobbyLogsCommandInput | GetNamespaceAnalyticsMatchmakerLiveCommandInput | GetNamespaceLobbyCommandInput | GetRayPerfLogsCommandInput | GetRegionTiersCommandInput | GroupBillingCheckoutCommandInput | InspectCommandInput | ListGameBuildsCommandInput | ListGameCdnSitesCommandInput | ListGameCustomAvatarsCommandInput | ListNamespaceLobbiesCommandInput | PrepareCustomAvatarUploadCommandInput | RemoveNamespaceCdnAuthUserCommandInput | RemoveNamespaceDomainCommandInput | SetGameBillingPlanCommandInput | SetNamespaceCdnAuthTypeCommandInput | ToggleNamespaceDomainPublicAuthCommandInput | UpdateGameNamespaceMatchmakerConfigCommandInput | UpdateGameNamespaceVersionCommandInput | UpdateNamespaceCdnAuthUserCommandInput | ValidateGameCommandInput | ValidateGameNamespaceCommandInput | ValidateGameNamespaceMatchmakerConfigCommandInput | ValidateGameNamespaceTokenDevelopmentCommandInput | ValidateGameVersionCommandInput | ValidateGroupCommandInput;
export declare type ServiceOutputTypes = AddNamespaceDomainCommandOutput | CompleteCustomAvatarUploadCommandOutput | CompleteUploadCommandOutput | ConvertGroupCommandOutput | CreateCloudTokenCommandOutput | CreateGameBuildCommandOutput | CreateGameCdnSiteCommandOutput | CreateGameCommandOutput | CreateGameNamespaceCommandOutput | CreateGameNamespaceTokenDevelopmentCommandOutput | CreateGameNamespaceTokenPublicCommandOutput | CreateGameVersionCommandOutput | DeleteMatchmakerLobbyCommandOutput | ExportLobbyLogsCommandOutput | ExportMatchmakerLobbyHistoryCommandOutput | GameBannerUploadCompleteCommandOutput | GameBannerUploadPrepareCommandOutput | GameLogoUploadCompleteCommandOutput | GameLogoUploadPrepareCommandOutput | GetGameBillingCommandOutput | GetGameBillingPlansCommandOutput | GetGameByIdCommandOutput | GetGameNamespaceByIdCommandOutput | GetGameVersionByIdCommandOutput | GetGamesCommandOutput | GetGroupBillingCommandOutput | GetGroupInvoicesListCommandOutput | GetLobbyLogsCommandOutput | GetNamespaceAnalyticsMatchmakerLiveCommandOutput | GetNamespaceLobbyCommandOutput | GetRayPerfLogsCommandOutput | GetRegionTiersCommandOutput | GroupBillingCheckoutCommandOutput | InspectCommandOutput | ListGameBuildsCommandOutput | ListGameCdnSitesCommandOutput | ListGameCustomAvatarsCommandOutput | ListNamespaceLobbiesCommandOutput | PrepareCustomAvatarUploadCommandOutput | RemoveNamespaceCdnAuthUserCommandOutput | RemoveNamespaceDomainCommandOutput | SetGameBillingPlanCommandOutput | SetNamespaceCdnAuthTypeCommandOutput | ToggleNamespaceDomainPublicAuthCommandOutput | UpdateGameNamespaceMatchmakerConfigCommandOutput | UpdateGameNamespaceVersionCommandOutput | UpdateNamespaceCdnAuthUserCommandOutput | ValidateGameCommandOutput | ValidateGameNamespaceCommandOutput | ValidateGameNamespaceMatchmakerConfigCommandOutput | ValidateGameNamespaceTokenDevelopmentCommandOutput | ValidateGameVersionCommandOutput | ValidateGroupCommandOutput;
...
declare type CloudServiceClientConfigType = PartialBy<Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & CustomEndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & UserAgentInputConfig, "endpoint">;
/**
 * The configuration interface of CloudServiceClient class constructor that set the region, credentials and other options.
 */
export interface CloudServiceClientConfig extends CloudServiceClientConfigType {
}
declare type CloudServiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & CustomEndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & UserAgentResolvedConfig;
/**
 * The resolved configuration interface of CloudServiceClient class. This is resolved and normalized from the {@link CloudServiceClientConfig | constructor configuration interface}.
 */
export interface CloudServiceClientResolvedConfig extends CloudServiceClientResolvedConfigType {
}
export declare class CloudServiceClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, CloudServiceClientResolvedConfig> {
    /**
     * The resolved configuration of CloudServiceClient class. This is resolved and normalized from the {@link CloudServiceClientConfig | constructor configuration interface}.
     */
    readonly config: CloudServiceClientResolvedConfig;
    constructor(configuration: CloudServiceClientConfig);
    /**
