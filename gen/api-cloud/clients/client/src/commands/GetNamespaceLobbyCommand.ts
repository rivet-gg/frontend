...
import {
  GetNamespaceLobbyInput,
  GetNamespaceLobbyOutput,
} from "../models/models_0";
import {
  deserializeAws_restJson1GetNamespaceLobbyCommand,
  serializeAws_restJson1GetNamespaceLobbyCommand,
 ...
 *
 */
export class GetNamespaceLobbyCommand extends $Command<GetNamespaceLobbyCommandInput, GetNamespaceLobbyCommandOutput, CloudServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: GetNamespaceLobbyCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<GetNamespaceLobbyCommandInput, GetNamespaceLobbyCommandOutput> {
    ...
    const commandName = "GetNamespaceLobbyCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog:
        GetNamespaceLobbyInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        GetNamespaceLobbyOutput.filterSensitiveLog,
    }
  ...
  private serialize(
    input: GetNamespaceLobbyCommandInput,
