...
import {
  ValidateGameNamespaceInput,
  ValidateGameNamespaceOutput,
} from "../models/models_0";
import {
  deserializeAws_restJson1ValidateGameNamespaceCommand,
  serializeAws_restJson1ValidateGameNamespaceCommand,
 ...
 *
 */
export class ValidateGameNamespaceCommand extends $Command<ValidateGameNamespaceCommandInput, ValidateGameNamespaceCommandOutput, CloudServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: ValidateGameNamespaceCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<ValidateGameNamespaceCommandInput, ValidateGameNamespaceCommandOutput> {
    ...
    const commandName = "ValidateGameNamespaceCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog:
        ValidateGameNamespaceInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        ValidateGameNamespaceOutput.filterSensitiveLog,
    }
  ...
  private serialize(
    input: ValidateGameNamespaceCommandInput,
