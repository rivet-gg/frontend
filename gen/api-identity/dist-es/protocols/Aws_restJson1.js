...
export var serializeAws_restJson1CancelGameLinkCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/game-links/cancel";
...
export var serializeAws_restJson1GetIdentityHandlesCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, query, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/batch/handle";
                query = __assign({}, (input.identityIds !== undefined && { "identity_ids": (input.identityIds || []).map(function (_entry) { return _entry; }) }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1GetIdentitySummariesCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, query, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/batch/summary";
                query = __assign({}, (input.identityIds !== undefined && { "identity_ids": (input.identityIds || []).map(function (_entry) { return _entry; }) }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var serializeAws_restJson1ListMutualFriendsCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, query, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/{identity_id}/mutual-friends";
                if (input.identityId !== undefined) {
                    labelValue = input.identityId;
                    if (labelValue.length <= 0) {
                        throw new Error('Empty value provided for input HTTP label: identityId.');
                ...
                query = __assign(__assign({}, (input.anchor !== undefined && { "anchor": input.anchor })), (input.count !== undefined && { "count": input.count.toString() }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1ListRecentFollowersCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, query, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/self/recent-followers";
                query = __assign(__assign(__assign({}, (input.anchor !== undefined && { "anchor": input.anchor })), (input.count !== undefined && { "count": input.count.toString() })), (input.watchIndex !== undefined && { "watch_index": input.watchIndex }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var serializeAws_restJson1MarkDeletionCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/self/delete-request";
                body = "";
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var serializeAws_restJson1RecentFollowerIgnoreCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/self/recent-followers/{identity_id}/ignore";
                if (input.identityId !== undefined) {
                    labelValue = input.identityId;
                    if (labelValue.length <= 0) {
                        throw new Error('Empty value provided for input HTTP label: identityId.');
...
export var serializeAws_restJson1ReportIdentityCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/{identity_id}/report";
                if (input.identityId !== undefined) {
                    labelValue = input.identityId;
                    if (labelValue.length <= 0) {
                        throw new Error('Empty value provided for input HTTP label: identityId.');
                ...
                body = JSON.stringify(__assign({}, (input.reason !== undefined && input.reason !== null && { "reason": input.reason })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1UnmarkDeletionCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var deserializeAws_restJson1CancelGameLinkCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1CancelGameLinkCommandError(output, context)];
                }
                contents = {
...
var deserializeAws_restJson1CancelGameLinkCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
...
export var deserializeAws_restJson1GetIdentityHandlesCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetIdentityHandlesCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
var deserializeAws_restJson1GetIdentityHandlesCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1GetIdentitySummariesCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetIdentitySummariesCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    identities: undefined,
...
var deserializeAws_restJson1GetIdentitySummariesCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1ListMutualFriendsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1ListMutualFriendsCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    anchor: undefined,
...
var deserializeAws_restJson1ListMutualFriendsCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1ListRecentFollowersCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1ListRecentFollowersCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    anchor: undefined,
...
var deserializeAws_restJson1ListRecentFollowersCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1MarkDeletionCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1MarkDeletionCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1MarkDeletionCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1RecentFollowerIgnoreCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1RecentFollowerIgnoreCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1RecentFollowerIgnoreCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1ReportIdentityCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1ReportIdentityCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1ReportIdentityCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1UnmarkDeletionCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1UnmarkDeletionCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1UnmarkDeletionCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
var serializeAws_restJson1UpdateIdentityGameActivity = function (input, context) {
    return __assign(__assign(__assign({}, (input.message !== undefined && input.message !== null && { "message": input.message })), (input.mutualMetadata !== undefined && input.mutualMetadata !== null && { "mutual_metadata": serializeAws_restJson1Document(input.mutualMetadata, context) })), (input.publicMetadata !== undefined && input.publicMetadata !== null && { "public_metadata": serializeAws_restJson1Document(input.publicMetadata, context) }));
};
...
var deserializeAws_restJson1GlobalEventChatThreadRemove = function (output, context) {
    return {
        threadId: __expectString(output.thread_id),
    };
};
...
var deserializeAws_restJson1GameTags = function (output, context) {
    var retVal = (output || []).filter(function (e) { return e != null; }).map(function (entry) {
        if (entry === null) {
            return null;
        }
...
var deserializeAws_restJson1IdentitySummaries = function (output, context) {
    var retVal = (output || []).filter(function (e) { return e != null; }).map(function (entry) {
        if (entry === null) {
            return null;
        }
...
var deserializeAws_restJson1IdentitySummary = function (output, context) {
    return {
        accountNumber: __expectInt32(output.account_number),
        avatarUrl: __expectString(output.avatar_url),
        displayName: __expectString(output.display_name),
...
var deserializeAws_restJson1PartyMemberStateInactive = function (output, context) {
    return {};
};
...
var deserializeAws_restJson1PartyMemberStateMatchmakerReady = function (output, context) {
    return {};
};
