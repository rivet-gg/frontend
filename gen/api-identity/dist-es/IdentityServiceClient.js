...
var IdentityServiceClient = (function (_super) {
    __extends(IdentityServiceClient, _super);
    function IdentityServiceClient(configuration) {
        var _this = this;
    ...
    IdentityServiceClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return IdentityServiceClient;
}(__Client));
export { IdentityServiceClient };
