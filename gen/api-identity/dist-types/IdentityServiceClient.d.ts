...
export declare type ServiceInputTypes = CancelGameLinkCommandInput | CompleteGameLinkCommandInput | CompleteIdentityAvatarUploadCommandInput | FollowIdentityCommandInput | GetGameLinkCommandInput | GetIdentityHandlesCommandInput | GetIdentityProfileCommandInput | GetIdentitySelfProfileCommandInput | GetIdentitySummariesCommandInput | ListActivitiesCommandInput | ListFollowersCommandInput | ListFollowingCommandInput | ListFriendsCommandInput | ListMutualFriendsCommandInput | ListRecentFollowersCommandInput | MarkDeletionCommandInput | PrepareGameLinkCommandInput | PrepareIdentityAvatarUploadCommandInput | RecentFollowerIgnoreCommandInput | RemoveIdentityGameActivityCommandInput | ReportIdentityCommandInput | SearchIdentitiesCommandInput | SetIdentityGameActivityCommandInput | SetupIdentityCommandInput | SignupForBetaCommandInput | UnfollowIdentityCommandInput | UnmarkDeletionCommandInput | UpdateIdentityProfileCommandInput | UpdateIdentityStatusCommandInput | ValidateIdentityProfileCommandInput | WatchEventsCommandInput;
export declare type ServiceOutputTypes = CancelGameLinkCommandOutput | CompleteGameLinkCommandOutput | CompleteIdentityAvatarUploadCommandOutput | FollowIdentityCommandOutput | GetGameLinkCommandOutput | GetIdentityHandlesCommandOutput | GetIdentityProfileCommandOutput | GetIdentitySelfProfileCommandOutput | GetIdentitySummariesCommandOutput | ListActivitiesCommandOutput | ListFollowersCommandOutput | ListFollowingCommandOutput | ListFriendsCommandOutput | ListMutualFriendsCommandOutput | ListRecentFollowersCommandOutput | MarkDeletionCommandOutput | PrepareGameLinkCommandOutput | PrepareIdentityAvatarUploadCommandOutput | RecentFollowerIgnoreCommandOutput | RemoveIdentityGameActivityCommandOutput | ReportIdentityCommandOutput | SearchIdentitiesCommandOutput | SetIdentityGameActivityCommandOutput | SetupIdentityCommandOutput | SignupForBetaCommandOutput | UnfollowIdentityCommandOutput | UnmarkDeletionCommandOutput | UpdateIdentityProfileCommandOutput | UpdateIdentityStatusCommandOutput | ValidateIdentityProfileCommandOutput | WatchEventsCommandOutput;
...
declare type IdentityServiceClientConfigType = PartialBy<Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & CustomEndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & UserAgentInputConfig, "endpoint">;
/**
...
declare type IdentityServiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & CustomEndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & UserAgentResolvedConfig;
/**
...
export declare class IdentityServiceClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, IdentityServiceClientResolvedConfig> {
    /**
