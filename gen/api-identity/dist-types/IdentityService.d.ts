...
export declare class IdentityService extends IdentityServiceClient {
     ...
     */
    cancelGameLink(args: CancelGameLinkCommandInput, options?: __HttpHandlerOptions): Promise<CancelGameLinkCommandOutput>;
    cancelGameLink(args: CancelGameLinkCommandInput, cb: (err: any, data?: CancelGameLinkCommandOutput) => void): void;
    cancelGameLink(args: CancelGameLinkCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CancelGameLinkCommandOutput) => void): void;
    /**
     ...
     */
    getIdentityHandles(args: GetIdentityHandlesCommandInput, options?: __HttpHandlerOptions): Promise<GetIdentityHandlesCommandOutput>;
    getIdentityHandles(args: GetIdentityHandlesCommandInput, cb: (err: any, data?: GetIdentityHandlesCommandOutput) => void): void;
    getIdentityHandles(args: GetIdentityHandlesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIdentityHandlesCommandOutput) => void): void;
    /**
     ...
     */
    getIdentitySummaries(args: GetIdentitySummariesCommandInput, options?: __HttpHandlerOptions): Promise<GetIdentitySummariesCommandOutput>;
    getIdentitySummaries(args: GetIdentitySummariesCommandInput, cb: (err: any, data?: GetIdentitySummariesCommandOutput) => void): void;
    getIdentitySummaries(args: GetIdentitySummariesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetIdentitySummariesCommandOutput) => void): void;
    /**
    ...
    listMutualFriends(args: ListMutualFriendsCommandInput, options?: __HttpHandlerOptions): Promise<ListMutualFriendsCommandOutput>;
    listMutualFriends(args: ListMutualFriendsCommandInput, cb: (err: any, data?: ListMutualFriendsCommandOutput) => void): void;
    listMutualFriends(args: ListMutualFriendsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListMutualFriendsCommandOutput) => void): void;
    listRecentFollowers(args: ListRecentFollowersCommandInput, options?: __HttpHandlerOptions): Promise<ListRecentFollowersCommandOutput>;
    listRecentFollowers(args: ListRecentFollowersCommandInput, cb: (err: any, data?: ListRecentFollowersCommandOutput) => void): void;
    listRecentFollowers(args: ListRecentFollowersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListRecentFollowersCommandOutput) => void): void;
    /**
     ...
     */
    markDeletion(args: MarkDeletionCommandInput, options?: __HttpHandlerOptions): Promise<MarkDeletionCommandOutput>;
    markDeletion(args: MarkDeletionCommandInput, cb: (err: any, data?: MarkDeletionCommandOutput) => void): void;
    markDeletion(args: MarkDeletionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: MarkDeletionCommandOutput) => void): void;
    /**
     ...
     */
    recentFollowerIgnore(args: RecentFollowerIgnoreCommandInput, options?: __HttpHandlerOptions): Promise<RecentFollowerIgnoreCommandOutput>;
    recentFollowerIgnore(args: RecentFollowerIgnoreCommandInput, cb: (err: any, data?: RecentFollowerIgnoreCommandOutput) => void): void;
    recentFollowerIgnore(args: RecentFollowerIgnoreCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: RecentFollowerIgnoreCommandOutput) => void): void;
    /**
     ...
     */
    reportIdentity(args: ReportIdentityCommandInput, options?: __HttpHandlerOptions): Promise<ReportIdentityCommandOutput>;
    reportIdentity(args: ReportIdentityCommandInput, cb: (err: any, data?: ReportIdentityCommandOutput) => void): void;
    reportIdentity(args: ReportIdentityCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ReportIdentityCommandOutput) => void): void;
    /**
     ...
     */
    unmarkDeletion(args: UnmarkDeletionCommandInput, options?: __HttpHandlerOptions): Promise<UnmarkDeletionCommandOutput>;
    unmarkDeletion(args: UnmarkDeletionCommandInput, cb: (err: any, data?: UnmarkDeletionCommandOutput) => void): void;
    unmarkDeletion(args: UnmarkDeletionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UnmarkDeletionCommandOutput) => void): void;
    /**
