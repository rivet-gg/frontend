...
exports.ChatMessageBodyText = exports.ChatMessageBodyPartyLeave = exports.ChatMessageBodyPartyJoinRequest = exports.ChatMessageBodyPartyJoin = exports.ChatMessageBodyPartyInvite = exports.ChatMessageBodyPartyActivityChange = exports.ChatMessageBodyIdentityFollow = exports.ChatMessageBodyGroupMemberKick = exports.ChatMessageBodyGroupLeave = exports.ChatMessageBodyGroupJoin = exports.ChatMessageBodyDeleted = exports.ChatMessageBodyChatCreate = exports.ChatThreadExternalLinks = exports.WatchEventsInput = exports.CompleteIdentityAvatarUploadOutput = exports.CompleteIdentityAvatarUploadInput = exports.CompleteGameLinkOutput = exports.CompleteGameLinkInput = exports.CancelGameLinkOutput = exports.CancelGameLinkInput = exports.ListActivitiesOutput = exports.WatchResponse = exports.GroupSummary = exports.GroupPublicity = exports.PartySummary = exports.PartyPublicity = exports.PartyPublicityLevel = exports.PartyMemberSummary = exports.PartyMemberState = exports.PartyMemberStateMatchmakerReady = exports.PartyMemberStateMatchmakerLobby = exports.PartyMemberStateMatchmakerFindingLobby = exports.PartyMemberStateInactive = exports.IdentityHandle = exports.IdentityPresence = exports.IdentityStatus = exports.IdentityGameActivity = exports.PartyHandle = exports.PartyExternalLinks = exports.PartyActivity = exports.PartyActivityMatchmakerLobby = exports.PartyMatchmakerLobby = exports.PartyActivityMatchmakerFindingLobby = exports.GameHandle = exports.PartyActivityIdle = exports.IdentityExternalLinks = exports.GameSummary = exports.GroupHandle = exports.GroupExternalLinks = exports.ListActivitiesInput = void 0;
exports.ListFollowersOutput = exports.ListFollowersInput = exports.GetIdentitySummariesOutput = exports.IdentitySummary = exports.GetIdentitySummariesInput = exports.GetIdentitySelfProfileOutput = exports.GetIdentitySelfProfileInput = exports.GetIdentityProfileOutput = exports.GetIdentityProfileInput = exports.GetIdentityHandlesOutput = exports.GetIdentityHandlesInput = exports.GetGameLinkOutput = exports.GameLinkStatus = exports.GetGameLinkNewIdentity = exports.GetGameLinkInput = exports.FollowIdentityOutput = exports.FollowIdentityInput = exports.WatchEventsOutput = exports.GlobalEvent = exports.GlobalEventNotification = exports.GlobalEventKind = exports.GlobalEventPartyUpdate = exports.GlobalEventMatchmakerLobbyJoin = exports.MatchmakerLobbyJoinInfo = exports.MatchmakerLobbyJoinInfoRegion = exports.MatchmakerLobbyJoinInfoPort = exports.MatchmakerLobbyJoinInfoPortRange = exports.MatchmakerLobbyJoinInfoPlayer = exports.GlobalEventIdentityUpdate = exports.IdentityProfile = exports.IdentityLinkedAccount = exports.IdentityEmailLinkedAccount = exports.IdentityGroup = exports.GameStatSummary = exports.GameStat = exports.GameStatConfig = exports.GameStatSortingMethod = exports.GameStatFormatMethod = exports.GameStatAggregationMethod = exports.IdentityDevState = exports.GlobalEventChatThreadRemove = exports.GlobalEventChatRead = exports.GlobalEventChatMessage = exports.ChatThread = exports.ChatTopic = exports.ChatTopicParty = exports.ChatTopicGroup = exports.ChatTopicDirect = exports.ChatMessage = exports.ChatMessageBody = void 0;
exports.UnauthorizedError = exports.RateLimitError = exports.NotFoundError = exports.InternalError = exports.ForbiddenError = exports.BadRequestError = exports.PrepareGameLinkOutput = exports.PrepareGameLinkInput = exports.ValidateIdentityProfileOutput = exports.ValidationError = exports.ValidateIdentityProfileInput = exports.UpdateIdentityStatusOutput = exports.UpdateIdentityStatusInput = exports.UpdateIdentityProfileOutput = exports.UpdateIdentityProfileInput = exports.UnmarkDeletionOutput = exports.UnmarkDeletionInput = exports.UnfollowIdentityOutput = exports.UnfollowIdentityInput = exports.SignupForBetaOutput = exports.SignupForBetaInput = exports.SetupIdentityOutput = exports.SetupIdentityInput = exports.SetIdentityGameActivityOutput = exports.SetIdentityGameActivityInput = exports.UpdateIdentityGameActivity = exports.SearchIdentitiesOutput = exports.SearchIdentitiesInput = exports.ReportIdentityOutput = exports.ReportIdentityInput = exports.RemoveIdentityGameActivityOutput = exports.RemoveIdentityGameActivityInput = exports.RecentFollowerIgnoreOutput = exports.RecentFollowerIgnoreInput = exports.PrepareIdentityAvatarUploadOutput = exports.UploadPresignedRequest = exports.PrepareIdentityAvatarUploadInput = exports.MarkDeletionOutput = exports.MarkDeletionInput = exports.ListRecentFollowersOutput = exports.ListRecentFollowersInput = exports.ListMutualFriendsOutput = exports.ListMutualFriendsInput = exports.ListFriendsOutput = exports.ListFriendsInput = exports.ListFollowingOutput = exports.ListFollowingInput = void 0;
...
var PartyMemberStateInactive;
(function (PartyMemberStateInactive) {
    PartyMemberStateInactive.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(PartyMemberStateInactive = exports.PartyMemberStateInactive || (exports.PartyMemberStateInactive = {}));
...
var PartyMemberStateMatchmakerReady;
(function (PartyMemberStateMatchmakerReady) {
    PartyMemberStateMatchmakerReady.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(PartyMemberStateMatchmakerReady = exports.PartyMemberStateMatchmakerReady || (exports.PartyMemberStateMatchmakerReady = {}));
var PartyMemberState;
(function (PartyMemberState) {
    PartyMemberState.visit = (value, visitor) => {
        if (value.inactive !== undefined)
            return visitor.inactive(value.inactive);
        if (value.matchmakerReady !== undefined)
            return visitor.matchmakerReady(value.matchmakerReady);
        if (value.matchmakerFindingLobby !== undefined)
            return visitor.matchmakerFindingLobby(value.matchmakerFindingLobby);
        if (value.matchmakerLobby !== undefined)
            return visitor.matchmakerLobby(value.matchmakerLobby);
    ...
    PartyMemberState.filterSensitiveLog = (obj) => {
        if (obj.inactive !== undefined)
            return { inactive: PartyMemberStateInactive.filterSensitiveLog(obj.inactive)
            };
        if (obj.matchmakerReady !== undefined)
            return { matchmakerReady: PartyMemberStateMatchmakerReady.filterSensitiveLog(obj.matchmakerReady)
            };
        if (obj.matchmakerFindingLobby !== undefined)
...
var CancelGameLinkInput;
(function (CancelGameLinkInput) {
    CancelGameLinkInput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.identityLinkToken && { identityLinkToken: smithy_client_1.SENSITIVE_STRING
        }),
    });
})(CancelGameLinkInput = exports.CancelGameLinkInput || (exports.CancelGameLinkInput = {}));
var CancelGameLinkOutput;
(function (CancelGameLinkOutput) {
    CancelGameLinkOutput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(CancelGameLinkOutput = exports.CancelGameLinkOutput || (exports.CancelGameLinkOutput = {}));
...
(function (GlobalEventChatThreadRemove) {
    GlobalEventChatThreadRemove.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(GlobalEventChatThreadRemove = exports.GlobalEventChatThreadRemove || (exports.GlobalEventChatThreadRemove = {}));
...
(function (GlobalEventKind) {
    GlobalEventKind.visit = (value, visitor) => {
        ...
        if (value.chatThreadRemove !== undefined)
            return visitor.chatThreadRemove(value.chatThreadRemove);
        return visitor._(value.$unknown[0], value.$unknown[1]);
    };
    GlobalEventKind.filterSensitiveLog = (obj) => {
        ...
        if (obj.chatThreadRemove !== undefined)
            return { chatThreadRemove: GlobalEventChatThreadRemove.filterSensitiveLog(obj.chatThreadRemove)
            };
        if (obj.$unknown !== undefined)
            return { [obj.$unknown[0]]: 'UNKNOWN' };
    };
...
(function (GetGameLinkOutput) {
    GetGameLinkOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.currentIdentity && { currentIdentity: IdentityHandle.filterSensitiveLog(obj.currentIdentity)
        }),
...
var GetIdentityHandlesInput;
(function (GetIdentityHandlesInput) {
    GetIdentityHandlesInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(GetIdentityHandlesInput = exports.GetIdentityHandlesInput || (exports.GetIdentityHandlesInput = {}));
var GetIdentityHandlesOutput;
(function (GetIdentityHandlesOutput) {
    GetIdentityHandlesOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.identities && { identities: obj.identities.map(item => IdentityHandle.filterSensitiveLog(item))
        }),
    });
})(GetIdentityHandlesOutput = exports.GetIdentityHandlesOutput || (exports.GetIdentityHandlesOutput = {}));
...
var GetIdentitySummariesInput;
(function (GetIdentitySummariesInput) {
    GetIdentitySummariesInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(GetIdentitySummariesInput = exports.GetIdentitySummariesInput || (exports.GetIdentitySummariesInput = {}));
var IdentitySummary;
(function (IdentitySummary) {
    IdentitySummary.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.party && { party: PartyHandle.filterSensitiveLog(obj.party)
        }),
    });
})(IdentitySummary = exports.IdentitySummary || (exports.IdentitySummary = {}));
var GetIdentitySummariesOutput;
(function (GetIdentitySummariesOutput) {
    GetIdentitySummariesOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.identities && { identities: obj.identities.map(item => IdentitySummary.filterSensitiveLog(item))
        }),
    });
})(GetIdentitySummariesOutput = exports.GetIdentitySummariesOutput || (exports.GetIdentitySummariesOutput = {}));
...
var ListMutualFriendsInput;
(function (ListMutualFriendsInput) {
    ListMutualFriendsInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(ListMutualFriendsInput = exports.ListMutualFriendsInput || (exports.ListMutualFriendsInput = {}));
var ListMutualFriendsOutput;
(function (ListMutualFriendsOutput) {
    ListMutualFriendsOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.identities && { identities: obj.identities.map(item => IdentityHandle.filterSensitiveLog(item))
        }),
    });
})(ListMutualFriendsOutput = exports.ListMutualFriendsOutput || (exports.ListMutualFriendsOutput = {}));
var ListRecentFollowersInput;
(function (ListRecentFollowersInput) {
    ListRecentFollowersInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(ListRecentFollowersInput = exports.ListRecentFollowersInput || (exports.ListRecentFollowersInput = {}));
var ListRecentFollowersOutput;
(function (ListRecentFollowersOutput) {
    ListRecentFollowersOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.identities && { identities: obj.identities.map(item => IdentityHandle.filterSensitiveLog(item))
        }),
    });
})(ListRecentFollowersOutput = exports.ListRecentFollowersOutput || (exports.ListRecentFollowersOutput = {}));
var MarkDeletionInput;
(function (MarkDeletionInput) {
    MarkDeletionInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(MarkDeletionInput = exports.MarkDeletionInput || (exports.MarkDeletionInput = {}));
var MarkDeletionOutput;
(function (MarkDeletionOutput) {
    MarkDeletionOutput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(MarkDeletionOutput = exports.MarkDeletionOutput || (exports.MarkDeletionOutput = {}));
...
var RecentFollowerIgnoreInput;
(function (RecentFollowerIgnoreInput) {
    RecentFollowerIgnoreInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(RecentFollowerIgnoreInput = exports.RecentFollowerIgnoreInput || (exports.RecentFollowerIgnoreInput = {}));
var RecentFollowerIgnoreOutput;
(function (RecentFollowerIgnoreOutput) {
    RecentFollowerIgnoreOutput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(RecentFollowerIgnoreOutput = exports.RecentFollowerIgnoreOutput || (exports.RecentFollowerIgnoreOutput = {}));
...
(function (ReportIdentityInput) {
    ReportIdentityInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(ReportIdentityInput = exports.ReportIdentityInput || (exports.ReportIdentityInput = {}));
var ReportIdentityOutput;
(function (ReportIdentityOutput) {
    ReportIdentityOutput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(ReportIdentityOutput = exports.ReportIdentityOutput || (exports.ReportIdentityOutput = {}));
...
var UnmarkDeletionInput;
(function (UnmarkDeletionInput) {
    UnmarkDeletionInput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(UnmarkDeletionInput = exports.UnmarkDeletionInput || (exports.UnmarkDeletionInput = {}));
var UnmarkDeletionOutput;
(function (UnmarkDeletionOutput) {
    UnmarkDeletionOutput.filterSensitiveLog = (obj) => ({
        ...obj,
    });
})(UnmarkDeletionOutput = exports.UnmarkDeletionOutput || (exports.UnmarkDeletionOutput = {}));
