...
exports.deserializeAws_restJson1RecentFollowerIgnoreCommand = exports.deserializeAws_restJson1PrepareIdentityAvatarUploadCommand = exports.deserializeAws_restJson1PrepareGameLinkCommand = exports.deserializeAws_restJson1MarkDeletionCommand = exports.deserializeAws_restJson1ListRecentFollowersCommand = exports.deserializeAws_restJson1ListMutualFriendsCommand = exports.deserializeAws_restJson1ListFriendsCommand = exports.deserializeAws_restJson1ListFollowingCommand = exports.deserializeAws_restJson1ListFollowersCommand = exports.deserializeAws_restJson1ListActivitiesCommand = exports.deserializeAws_restJson1GetIdentitySummariesCommand = exports.deserializeAws_restJson1GetIdentitySelfProfileCommand = exports.deserializeAws_restJson1GetIdentityProfileCommand = exports.deserializeAws_restJson1GetIdentityHandlesCommand = exports.deserializeAws_restJson1GetGameLinkCommand = exports.deserializeAws_restJson1FollowIdentityCommand = exports.deserializeAws_restJson1CompleteIdentityAvatarUploadCommand = exports.deserializeAws_restJson1CompleteGameLinkCommand = exports.deserializeAws_restJson1CancelGameLinkCommand = exports.serializeAws_restJson1WatchEventsCommand = exports.serializeAws_restJson1ValidateIdentityProfileCommand = exports.serializeAws_restJson1UpdateIdentityStatusCommand = exports.serializeAws_restJson1UpdateIdentityProfileCommand = exports.serializeAws_restJson1UnmarkDeletionCommand = exports.serializeAws_restJson1UnfollowIdentityCommand = exports.serializeAws_restJson1SignupForBetaCommand = exports.serializeAws_restJson1SetupIdentityCommand = exports.serializeAws_restJson1SetIdentityGameActivityCommand = exports.serializeAws_restJson1SearchIdentitiesCommand = exports.serializeAws_restJson1ReportIdentityCommand = exports.serializeAws_restJson1RemoveIdentityGameActivityCommand = exports.serializeAws_restJson1RecentFollowerIgnoreCommand = exports.serializeAws_restJson1PrepareIdentityAvatarUploadCommand = exports.serializeAws_restJson1PrepareGameLinkCommand = exports.serializeAws_restJson1MarkDeletionCommand = exports.serializeAws_restJson1ListRecentFollowersCommand = exports.serializeAws_restJson1ListMutualFriendsCommand = exports.serializeAws_restJson1ListFriendsCommand = exports.serializeAws_restJson1ListFollowingCommand = exports.serializeAws_restJson1ListFollowersCommand = exports.serializeAws_restJson1ListActivitiesCommand = exports.serializeAws_restJson1GetIdentitySummariesCommand = exports.serializeAws_restJson1GetIdentitySelfProfileCommand = exports.serializeAws_restJson1GetIdentityProfileCommand = exports.serializeAws_restJson1GetIdentityHandlesCommand = exports.serializeAws_restJson1GetGameLinkCommand = exports.serializeAws_restJson1FollowIdentityCommand = exports.serializeAws_restJson1CompleteIdentityAvatarUploadCommand = exports.serializeAws_restJson1CompleteGameLinkCommand = exports.serializeAws_restJson1CancelGameLinkCommand = void 0;
exports.deserializeAws_restJson1WatchEventsCommand = exports.deserializeAws_restJson1ValidateIdentityProfileCommand = exports.deserializeAws_restJson1UpdateIdentityStatusCommand = exports.deserializeAws_restJson1UpdateIdentityProfileCommand = exports.deserializeAws_restJson1UnmarkDeletionCommand = exports.deserializeAws_restJson1UnfollowIdentityCommand = exports.deserializeAws_restJson1SignupForBetaCommand = exports.deserializeAws_restJson1SetupIdentityCommand = exports.deserializeAws_restJson1SetIdentityGameActivityCommand = exports.deserializeAws_restJson1SearchIdentitiesCommand = exports.deserializeAws_restJson1ReportIdentityCommand = exports.deserializeAws_restJson1RemoveIdentityGameActivityCommand = void 0;
const IdentityServiceServiceException_1 = require("../models/IdentityServiceServiceException");
const models_0_1 = require("../models/models_0");
const protocol_http_1 = require("@aws-sdk/protocol-http");
const smithy_client_1 = require("@aws-sdk/smithy-client");
const serializeAws_restJson1CancelGameLinkCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        'content-type': "application/json",
    };
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/game-links/cancel";
    let body;
    body = JSON.stringify({
...
exports.serializeAws_restJson1CancelGameLinkCommand = serializeAws_restJson1CancelGameLinkCommand;
...
const serializeAws_restJson1GetIdentityHandlesCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/batch/handle";
    const query = {
        ...(input.identityIds !== undefined && { "identity_ids": (input.identityIds || []).map(_entry => _entry) }),
    };
    let body;
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1GetIdentityHandlesCommand = serializeAws_restJson1GetIdentityHandlesCommand;
...
const serializeAws_restJson1GetIdentitySummariesCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/batch/summary";
    const query = {
        ...(input.identityIds !== undefined && { "identity_ids": (input.identityIds || []).map(_entry => _entry) }),
    };
    let body;
...
exports.serializeAws_restJson1GetIdentitySummariesCommand = serializeAws_restJson1GetIdentitySummariesCommand;
...
const serializeAws_restJson1ListMutualFriendsCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/{identity_id}/mutual-friends";
    if (input.identityId !== undefined) {
        const labelValue = input.identityId;
        if (labelValue.length <= 0) {
            throw new Error('Empty value provided for input HTTP label: identityId.');
...
exports.serializeAws_restJson1ListMutualFriendsCommand = serializeAws_restJson1ListMutualFriendsCommand;
const serializeAws_restJson1ListRecentFollowersCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/self/recent-followers";
    const query = {
        ...(input.anchor !== undefined && { "anchor": input.anchor }),
        ...(input.count !== undefined && { "count": input.count.toString() }),
        ...(input.watchIndex !== undefined && { "watch_index": input.watchIndex }),
...
exports.serializeAws_restJson1ListRecentFollowersCommand = serializeAws_restJson1ListRecentFollowersCommand;
const serializeAws_restJson1MarkDeletionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        'content-type': "application/json",
    };
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/self/delete-request";
    let body;
    body = "";
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1MarkDeletionCommand = serializeAws_restJson1MarkDeletionCommand;
...
const serializeAws_restJson1RecentFollowerIgnoreCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {};
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/self/recent-followers/{identity_id}/ignore";
    if (input.identityId !== undefined) {
        const labelValue = input.identityId;
        if (labelValue.length <= 0) {
            throw new Error('Empty value provided for input HTTP label: identityId.');
...
exports.serializeAws_restJson1RecentFollowerIgnoreCommand = serializeAws_restJson1RecentFollowerIgnoreCommand;
...
const serializeAws_restJson1ReportIdentityCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        'content-type': "application/json",
    };
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/identities/{identity_id}/report";
    if (input.identityId !== undefined) {
        const labelValue = input.identityId;
        if (labelValue.length <= 0) {
            throw new Error('Empty value provided for input HTTP label: identityId.');
...
exports.serializeAws_restJson1ReportIdentityCommand = serializeAws_restJson1ReportIdentityCommand;
...
const serializeAws_restJson1UnmarkDeletionCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        'content-type': "application/json",
    };
...
exports.serializeAws_restJson1UnmarkDeletionCommand = serializeAws_restJson1UnmarkDeletionCommand;
...
const deserializeAws_restJson1CancelGameLinkCommand = async (output, context) => {
...
exports.deserializeAws_restJson1CancelGameLinkCommand = deserializeAws_restJson1CancelGameLinkCommand;
const deserializeAws_restJson1CancelGameLinkCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
...
const deserializeAws_restJson1GetIdentityHandlesCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1GetIdentityHandlesCommand = deserializeAws_restJson1GetIdentityHandlesCommand;
const deserializeAws_restJson1GetIdentityHandlesCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1GetIdentitySummariesCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1GetIdentitySummariesCommand = deserializeAws_restJson1GetIdentitySummariesCommand;
const deserializeAws_restJson1GetIdentitySummariesCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1ListMutualFriendsCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1ListMutualFriendsCommand = deserializeAws_restJson1ListMutualFriendsCommand;
const deserializeAws_restJson1ListMutualFriendsCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1ListRecentFollowersCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1ListRecentFollowersCommand = deserializeAws_restJson1ListRecentFollowersCommand;
const deserializeAws_restJson1ListRecentFollowersCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1MarkDeletionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1MarkDeletionCommand = deserializeAws_restJson1MarkDeletionCommand;
const deserializeAws_restJson1MarkDeletionCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1RecentFollowerIgnoreCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1RecentFollowerIgnoreCommand = deserializeAws_restJson1RecentFollowerIgnoreCommand;
const deserializeAws_restJson1RecentFollowerIgnoreCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1ReportIdentityCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1ReportIdentityCommand = deserializeAws_restJson1ReportIdentityCommand;
const deserializeAws_restJson1ReportIdentityCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1UnmarkDeletionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1UnmarkDeletionCommand = deserializeAws_restJson1UnmarkDeletionCommand;
const deserializeAws_restJson1UnmarkDeletionCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1GlobalEventChatThreadRemove = (output, context) => {
    return {
        threadId: (0, smithy_client_1.expectString)(output.thread_id),
    };
};
...
const deserializeAws_restJson1IdentityProfile = (output, context) => {
    return {
        accountNumber: (0, smithy_client_1.expectInt32)(output.account_number),
        avatarUrl: (0, smithy_client_1.expectString)(output.avatar_url),
        awaitingDeletion: (0, smithy_client_1.expectBoolean)(output.awaiting_deletion),
        bio: (0, smithy_client_1.expectString)(output.bio),
        devState: (0, smithy_client_1.expectString)(output.dev_state),
        displayName: (0, smithy_client_1.expectString)(output.display_name),
        external: (output.external !== undefined && output.external !== null) ? deserializeAws_restJson1IdentityExternalLinks(output.external, context) : undefined,
        followerCount: (0, smithy_client_1.expectLong)(output.follower_count),
        following: (0, smithy_client_1.expectBoolean)(output.following),
        followingCount: (0, smithy_client_1.expectLong)(output.following_count),
        ...
        isFollowingMe: (0, smithy_client_1.expectBoolean)(output.is_following_me),
        isGameLinked: (0, smithy_client_1.expectBoolean)(output.is_game_linked),
        isMutualFollowing: (0, smithy_client_1.expectBoolean)(output.is_mutual_following),
        isRegistered: (0, smithy_client_1.expectBoolean)(output.is_registered),
...
const deserializeAws_restJson1IdentitySummaries = (output, context) => {
    const retVal = (output || []).filter((e) => e != null).map((entry) => {
        if (entry === null) {
            return null;
        }
...
const deserializeAws_restJson1IdentitySummary = (output, context) => {
    return {
        accountNumber: (0, smithy_client_1.expectInt32)(output.account_number),
        avatarUrl: (0, smithy_client_1.expectString)(output.avatar_url),
        displayName: (0, smithy_client_1.expectString)(output.display_name),
...
const deserializeAws_restJson1PartyMemberStateInactive = (output, context) => {
    return {};
};
...
const deserializeAws_restJson1PartyMemberStateMatchmakerReady = (output, context) => {
    return {};
};
...
const deserializeAws_restJson1PartyPublicity = (output, context) => {
    return {
        ...
        mutualFollowers: (0, smithy_client_1.expectString)(output.mutual_followers),
