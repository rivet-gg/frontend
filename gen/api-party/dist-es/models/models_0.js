...
(function (JoinPartyInput) {
    JoinPartyInput.filterSensitiveLog = function (obj) { return (__assign(__assign(__assign({}, obj), (obj.invite && { invite: JoinPartyInvite.filterSensitiveLog(obj.invite)
    })), (obj.matchmakerCurrentPlayerToken && { matchmakerCurrentPlayerToken: SENSITIVE_STRING
    }))); };
...
export var SetSelfInactiveInput;
(function (SetSelfInactiveInput) {
    SetSelfInactiveInput.filterSensitiveLog = function (obj) { return (__assign({}, obj)); };
})(SetSelfInactiveInput || (SetSelfInactiveInput = {}));
export var SetSelfInactiveOutput;
(function (SetSelfInactiveOutput) {
    SetSelfInactiveOutput.filterSensitiveLog = function (obj) { return (__assign({}, obj)); };
})(SetSelfInactiveOutput || (SetSelfInactiveOutput = {}));
...
(function (FindMatchmakerLobbyForPartyInput) {
    FindMatchmakerLobbyForPartyInput.filterSensitiveLog = function (obj) { return (__assign(__assign({}, obj), (obj.captcha && { captcha: CaptchaConfig.filterSensitiveLog(obj.captcha)
    }))); };
...
(function (JoinMatchmakerLobbyForPartyInput) {
    JoinMatchmakerLobbyForPartyInput.filterSensitiveLog = function (obj) { return (__assign(__assign({}, obj), (obj.captcha && { captcha: CaptchaConfig.filterSensitiveLog(obj.captcha)
    }))); };
...
export var MatchmakerSelfReadyInput;
(function (MatchmakerSelfReadyInput) {
    MatchmakerSelfReadyInput.filterSensitiveLog = function (obj) { return (__assign({}, obj)); };
})(MatchmakerSelfReadyInput || (MatchmakerSelfReadyInput = {}));
export var MatchmakerSelfReadyOutput;
(function (MatchmakerSelfReadyOutput) {
    MatchmakerSelfReadyOutput.filterSensitiveLog = function (obj) { return (__assign({}, obj)); };
})(MatchmakerSelfReadyOutput || (MatchmakerSelfReadyOutput = {}));
