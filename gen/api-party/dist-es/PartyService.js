...
import { MatchmakerSelfReadyCommand, } from "./commands/MatchmakerSelfReadyCommand";
...
import { SetSelfInactiveCommand, } from "./commands/SetSelfInactiveCommand";
...
var PartyService = (function (_super) {
    ...
    PartyService.prototype.matchmakerSelfReady = function (args, optionsOrCb, cb) {
        var command = new MatchmakerSelfReadyCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    PartyService.prototype.setSelfInactive = function (args, optionsOrCb, cb) {
        var command = new SetSelfInactiveCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
