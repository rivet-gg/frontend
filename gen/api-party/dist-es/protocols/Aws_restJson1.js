...
import { BadRequestError, CaptchaConfig, ForbiddenError, InternalError, JoinPartyInvite, NotFoundError, RateLimitError, UnauthorizedError, } from "../models/models_0";
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                body = JSON.stringify(__assign(__assign(__assign({}, (input.invite !== undefined && input.invite !== null && { "invite": serializeAws_restJson1JoinPartyInvite(input.invite, context) })), (input.matchmakerAutoJoinLobby !== undefined && input.matchmakerAutoJoinLobby !== null && { "matchmaker_auto_join_lobby": input.matchmakerAutoJoinLobby })), (input.matchmakerCurrentPlayerToken !== undefined && input.matchmakerCurrentPlayerToken !== null && { "matchmaker_current_player_token": input.matchmakerCurrentPlayerToken })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                body = JSON.stringify(__assign(__assign(__assign({}, (input.groups !== undefined && input.groups !== null && { "groups": input.groups })), (input.mutualFollowers !== undefined && input.mutualFollowers !== null && { "mutual_followers": input.mutualFollowers })), (input.public !== undefined && input.public !== null && { "public": input.public })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1MatchmakerSelfReadyCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/parties/self/members/self/matchmaker/ready";
                body = "";
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var serializeAws_restJson1SetSelfInactiveCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/parties/self/members/self/inactive";
                body = "";
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var deserializeAws_restJson1MatchmakerSelfReadyCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1MatchmakerSelfReadyCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1MatchmakerSelfReadyCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1SetSelfInactiveCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1SetSelfInactiveCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1SetSelfInactiveCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
var serializeAws_restJson1CreatePartyPublicityConfig = function (input, context) {
    return __assign(__assign(__assign({}, (input.groups !== undefined && input.groups !== null && { "groups": input.groups })), (input.mutualFollowers !== undefined && input.mutualFollowers !== null && { "mutual_followers": input.mutualFollowers })), (input.public !== undefined && input.public !== null && { "public": input.public }));
};
