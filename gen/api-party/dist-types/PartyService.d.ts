...
export declare class PartyService extends PartyServiceClient {
     ...
     */
    matchmakerSelfReady(args: MatchmakerSelfReadyCommandInput, options?: __HttpHandlerOptions): Promise<MatchmakerSelfReadyCommandOutput>;
    matchmakerSelfReady(args: MatchmakerSelfReadyCommandInput, cb: (err: any, data?: MatchmakerSelfReadyCommandOutput) => void): void;
    matchmakerSelfReady(args: MatchmakerSelfReadyCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: MatchmakerSelfReadyCommandOutput) => void): void;
    /**
    ...
    setSelfInactive(args: SetSelfInactiveCommandInput, options?: __HttpHandlerOptions): Promise<SetSelfInactiveCommandOutput>;
    setSelfInactive(args: SetSelfInactiveCommandInput, cb: (err: any, data?: SetSelfInactiveCommandOutput) => void): void;
    setSelfInactive(args: SetSelfInactiveCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SetSelfInactiveCommandOutput) => void): void;
}
