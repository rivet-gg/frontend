...
const serializeAws_restJson1MatchmakerSelfReadyCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        'content-type': "application/json",
    };
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/parties/self/members/self/matchmaker/ready";
    let body;
    body = "";
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1MatchmakerSelfReadyCommand = serializeAws_restJson1MatchmakerSelfReadyCommand;
...
const serializeAws_restJson1SetSelfInactiveCommand = async (input, context) => {
    const { hostname, protocol = "https", port, path: basePath } = await context.endpoint();
    const headers = {
        'content-type': "application/json",
    };
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')}` + "/parties/self/members/self/inactive";
    let body;
    body = "";
    return new protocol_http_1.HttpRequest({
        protocol,
...
exports.serializeAws_restJson1SetSelfInactiveCommand = serializeAws_restJson1SetSelfInactiveCommand;
...
const deserializeAws_restJson1MatchmakerSelfReadyCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1MatchmakerSelfReadyCommand = deserializeAws_restJson1MatchmakerSelfReadyCommand;
const deserializeAws_restJson1MatchmakerSelfReadyCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
...
const deserializeAws_restJson1SetSelfInactiveCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
...
exports.deserializeAws_restJson1SetSelfInactiveCommand = deserializeAws_restJson1SetSelfInactiveCommand;
const deserializeAws_restJson1SetSelfInactiveCommandError = async (output, context) => {
    const parsedOutput = {
        ...output,
        body: await parseBody(output.body, context)
    };
