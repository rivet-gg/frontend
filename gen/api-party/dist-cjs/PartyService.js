...
const MatchmakerSelfReadyCommand_1 = require("./commands/MatchmakerSelfReadyCommand");
...
const SetSelfInactiveCommand_1 = require("./commands/SetSelfInactiveCommand");
...
class PartyService extends PartyServiceClient_1.PartyServiceClient {
    ...
    matchmakerSelfReady(args, optionsOrCb, cb) {
        const command = new MatchmakerSelfReadyCommand_1.MatchmakerSelfReadyCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    setSelfInactive(args, optionsOrCb, cb) {
        const command = new SetSelfInactiveCommand_1.SetSelfInactiveCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
