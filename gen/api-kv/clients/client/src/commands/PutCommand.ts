...
import {
  deserializeAws_restJson1PutCommand,
  serializeAws_restJson1PutCommand,
 ...
 *
 */
export class PutCommand extends $Command<PutCommandInput, PutCommandOutput, KvServiceClientResolvedConfig> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        PutInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        PutOutput.filterSensitiveLog,
    }
