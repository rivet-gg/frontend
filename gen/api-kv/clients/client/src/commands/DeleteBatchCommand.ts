...
import {
  deserializeAws_restJson1DeleteBatchCommand,
  serializeAws_restJson1DeleteBatchCommand,
 ...
 *
 */
export class DeleteBatchCommand extends $Command<DeleteBatchCommandInput, DeleteBatchCommandOutput, KvServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: DeleteBatchCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<DeleteBatchCommandInput, DeleteBatchCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        DeleteBatchRequest.filterSensitiveLog,
      outputFilterSensitiveLog:
        DeleteBatchOutput.filterSensitiveLog,
    }
