...
var GroupServiceClient = (function (_super) {
    __extends(GroupServiceClient, _super);
    function GroupServiceClient(configuration) {
        var _this = this;
        function rivetConfig(input) {
            ...
            if (endpoint === null) {
                try {
                    endpoint = (_b = process.env.RIVET_GROUP_API_URL) !== null && _b !== void 0 ? _b : null;
                }
                catch (_f) {
                }
                if (endpoint === null) {
            ...
            if (token === null) {
                try {
                    token = (_e = (_d = process.env.RIVET_GROUP_TOKEN) !== null && _d !== void 0 ? _d : process.env.RIVET_TOKEN) !== null && _e !== void 0 ? _e : null;
                }
                catch (_g) {
                }
            }
    ...
    GroupServiceClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return GroupServiceClient;
}(__Client));
export { GroupServiceClient };
