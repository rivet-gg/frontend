 ...
 *
 */
export class GetGroupProfileCommand extends $Command<GetGroupProfileCommandInput, GetGroupProfileCommandOutput, GroupServiceClientResolvedConfig> {
  ...
  resolveMiddleware(
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        GetGroupProfileInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        GetGroupProfileOutput.filterSensitiveLog,
    }
