...
import {
  deserializeAws_restJson1GetGroupSummaryCommand,
  serializeAws_restJson1GetGroupSummaryCommand,
...
export class GetGroupSummaryCommand extends $Command<GetGroupSummaryCommandInput, GetGroupSummaryCommandOutput, GroupServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: GetGroupSummaryCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<GetGroupSummaryCommandInput, GetGroupSummaryCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        GetGroupSummaryInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        GetGroupSummaryOutput.filterSensitiveLog,
    }
