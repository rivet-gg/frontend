...
exports.PortalServiceClient = void 0;
...
class PortalServiceClient extends smithy_client_1.Client {
    constructor(configuration) {
        function rivetConfig(input) {
            ...
            if (endpoint === null) {
                try {
                    endpoint = (_b = process.env.RIVET_PORTAL_API_URL) !== null && _b !== void 0 ? _b : null;
                }
                catch (_f) {
                }
                if (endpoint === null) {
            ...
            if (token === null) {
                try {
                    token = (_e = (_d = process.env.RIVET_PORTAL_TOKEN) !== null && _d !== void 0 ? _d : process.env.RIVET_TOKEN) !== null && _e !== void 0 ? _e : null;
                }
                catch (_g) {
                }
            }
...
exports.PortalServiceClient = PortalServiceClient;
